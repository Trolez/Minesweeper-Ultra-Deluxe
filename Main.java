...
public class Main extends JFrame implements ComponentListener, ItemListener {
	...
	public Main (String[] args){
		...
		setTitle("Minesweeper Ultra Deluxe (v.0.18)");
	...
	public void ShowHighscoreDialog(){
		...
		if (Counter.count < scoreManager.GetLowestScore(Board.difficulty) || scoreManager.getScores(Board.difficulty).size() < 10){
			Date date = new Date();
			String scoreName = (String)JOptionPane.showInputDialog(this, "Please enter your name for the highscore", "You made the highscore!", JOptionPane.PLAIN_MESSAGE, null, null, System.getProperty("user.name"));
