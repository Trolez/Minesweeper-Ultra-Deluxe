...
public class Cell {
      ...
      if (mine) {
        ...
        switch (degree) {
          ...
          case 2:
            ...
            break;
          case 3:
            g2d.setColor(new Color(220, 125, 0));
            break;
          case 4:
            g2d.setColor(new Color(200, 0, 215));
            break;
          case 5:
            g2d.setColor(new Color(217, 0, 0));
            break;
          case 6:
            g2d.setColor(new Color(0, 200, 200));
            break;
          case 7:
            g2d.setColor(new Color(160, 110, 50));
            break;
          case 8:
  ...
  public void resize() {
    ...
    gradient = new GradientPaint(0, (int) (y * height), new Color(120, 120, 120), 0, (int) (y * height + height),
        DARKGRAY);
    lightGradient = new GradientPaint(0, (int) (y * height), new Color(190, 190, 190), 0, (int) (y * height + height),
        GRAY);
    lightestGradient = new GradientPaint(0, (int) (y * height), new Color(200, 200, 200), 0,
        (int) (y * height + height), LIGHTGRAY);
    hoverGradient = new GradientPaint(0, (int) (y * height), new Color(160, 160, 160), 0, (int) (y * height + height),
